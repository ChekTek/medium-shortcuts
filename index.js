...
if (isWindows) {
  ...
  // TODO: Get the mac shortcuts
  console.log("set mac keys");
} else {
  // TODO: Alert the user the system could not be determined possibly select keyboard button
  console.log("pick your keys");
}
